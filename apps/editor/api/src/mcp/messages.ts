...
export const MCP_TOOL_TEXT = {
  ...
  check_draft: {
    title: "형식 · SEO 검사",
    description:
      "저장하지 않고 markdown 형식을 검사해 틀린 곳을 알려준다. 형식이 맞으면 seo(검색 노출 점검)와 seoScore(0~100 점수)도 준다 — title · description · keyword를 함께 주면 그것까지 본다(메타를 모두 줘야 create · update 점수와 비교할 수 있다). 이미 저장된 글을 검사할 때는 slug도 준다(자기 글과의 제목 중복을 빼려고).",
  },
  create_draft: {
    title: "초안 만들기",
    description:
