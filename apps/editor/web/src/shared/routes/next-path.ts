import { NEXT_PARAM, ROUTES } from "./constants";

const HOME = ROUTES.home;
// 제어 문자(U+0000–U+001F, U+007F) — 줄바꿈 · 탭 등이 든 주소는 브라우저가 지우고 해석해 다른 출처가 될 수 있다
...
// 라우터는 경로를 대소문자 구분 없이 맞춘다(React Router 기본 caseSensitive: false) — `/LOGIN`도 로그인 화면이다
