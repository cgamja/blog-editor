# editor-sticker-copy Specification

## Purpose

고른 스티커 하나를 ⌘/Ctrl+C · ⌘/Ctrl+V로 같은 블록에 복제한다 — 복사본은 탭 메모리에만 두고, 스티커 버튼 포커스 중의 복사 키는 본문 기본 동작으로 새지 않게 막는다(이슈 #129, adr-008 · adr-027).
