...
- [x] 2.1 계약 표 · `api/openapi.json` → verify: 계약 테스트
- [x] 2.2 설정 저장소 · 라우트 · MCP 가이드 · 가져오기 미리보기 → verify: 1.1 api 초록
- [x] 2.3 web 순수 함수 · 대화상자 · `/connect` → verify: 1.1 web 초록 · typecheck · lint
- [x] 2.4 실브라우저: 가져오기(성공 · 막힘) · `/connect` 가이드 저장 · AI로 쓰기 → verify: 스크린샷 · 콘솔 오류 0
